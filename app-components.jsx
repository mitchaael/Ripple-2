...
// ─── Add Sheet ────────────────────────────────────────────────
function AddSheet({ onClose, onAdd, onTemplate }) {
  const T = useT();
      ...
      <div className="sheet" style={{background:T.sheetBg,maxHeight:'88%',overflowY:'auto'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:18}}>
          ...
          <div style={{display:'flex',gap:8}}>
            {onTemplate&&<button onClick={onTemplate} style={{padding:'6px 12px',borderRadius:10,border:`1px solid ${T.accentBorder}`,background:T.accentDim,color:T.accentText,fontFamily:'Inter,sans-serif',fontSize:12,fontWeight:600,cursor:'pointer'}}>📋 Plantillas</button>}
      ...
      <div style={{flex:1,overflow:'auto',padding:'24px 20px 20px'}}>
        {step===0?(
          <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100%',textAlign:'center',gap:14,paddingBottom:40}}>
            ...
            <h1 style={{fontSize:26,fontWeight:900,background:'linear-gradient(135deg,#6366f1,#ec4899)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',lineHeight:1.15}}>Ripple</h1>
            <p style={{color:T.textDim,fontSize:15,lineHeight:1.6,maxWidth:240}}>Pequeños hábitos, mejor versión de ti.</p>
